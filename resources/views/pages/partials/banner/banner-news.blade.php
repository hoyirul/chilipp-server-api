<div id="beranda" class="main-banner">
  <div class="left-banner">
    ...
    <p class="text-justify">Solusi yang kami tawarkan adalah sebuah sistem aplikasi yang membantu permasalahan pengepul dan petani cabai dalam memperkirakan harga cabai menggunakan algoritma machine learning. </p>
    <div class="text-left"><br>
      <a href="#news" class="btn btn-app btn-width-same">Selengkapnya</a>
