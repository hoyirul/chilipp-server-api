...
<div class="container fs-normal">
  ...
  <div class="card shadow mb-5 border-0">
    <div class="card-body">
      ...
      <a href="/u/estimations/create" class="btn btn-primary py-2 px-3 fs-normal float-right mb-3 shadow-sm"><span class="fas fa-user-plus"></span> Tambah Data</a>
        ...
        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Rp. {{ number_format($row->estimasi) }} Perkilogram</td>
              <td>
                <form action="/u/estimations/{{ $row->id }}" onsubmit="return confirm('Apakah anda yakin akan menghapus data?')" method="post">
                  @csrf
                  @method('DELETE')

                  <a href="/u/estimations/{{ $row->id }}/edit" class="btn fs-small btn-info text-decoration-none">
