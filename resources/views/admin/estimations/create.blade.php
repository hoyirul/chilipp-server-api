  ...
  @endif
   ...
   <div class="card shadow mb-4 border-0">
      ...
      <div class="card-body container-fluid">
         <form method="post" action="/u/estimations">
          @csrf
          <div class="row">
            <div class="col-xl-6 mr-auto">
              <div class="form-group">
                <label for="provinsi">Provinsi</label>
                <input type="text" required placeholder="Provinsi" class="form-control fs-normal form-spacer-20x15 @error('provinsi') is-invalid @enderror" id="provinsi" name="provinsi" data-toggle="tooltip" data-placement="right" value="{{ old('provinsi') }}">
                @error('provinsi')
            ...
            <div class="col-xl-6 ml-auto">
              <div class="form-group">
                ...
                <input type="number" required placeholder="Estimasi" class="form-control fs-normal form-spacer-20x15 @error('estimasi') is-invalid @enderror" id="estimasi" name="estimasi" data-toggle="tooltip" data-placement="right" value="{{ old('estimasi') }}">
                @error('estimasi')
                  <div class="invalid-feedback ml-1">{{ $message }}</div>
                @enderror
              </div>
