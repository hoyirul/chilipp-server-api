        ...
        <div class="row">
          ...
          <div class="col-xl-6 ml-auto">
            <div class="form-group">
              ...
              <input type="text" readonly placeholder="Nama Lengkap" class="form-control fs-normal form-spacer-20x15 @error('nama') is-invalid @enderror" id="nama" name="nama" data-toggle="tooltip" data-placement="right"  value="{{ $user->nama }}">
              @error('nama')
                <div class="invalid-feedback ml-1">{{ $message }}</div>
              @enderror
            </div>
